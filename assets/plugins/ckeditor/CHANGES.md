...
* [#10360](http://dev.ckeditor.com/ticket/10360): Fixed: ARIA `status="application"` should not be used for dialog windows.
* [#10361](http://dev.ckeditor.com/ticket/10361): Fixed: ARIA `status="application"` should not be used for floating panels.

              ...
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Formulir Data User Baru</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    
                    <form status="form" id="addUser" action="<?php echo base_url() ?>addNewUser" method="post" status="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <b><?php echo $status[1]->status; ?></b>
                                        <input type="hidden" name="status" value="<?php echo $status[1]->statusId;  ?>" />
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.box-body -->
